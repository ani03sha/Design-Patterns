...
public class AdapterPatternTest {
	...
	/**
	 * This method runs before the test execution and sets the bean objects in the
	 * beans Map.
	 */
	@BeforeEach
	public void setUp() {
	 ...
	 * object. The Adapter ({@link FishingBoatAdapter} ) converts the interface of
	 * the target class ( {@link FishingBoat}) into a suitable one expected by the
	 * client ({@link Captain} ).
	 */
	@Test
